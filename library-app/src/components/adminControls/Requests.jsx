...
import { getAllRequests, removeFromRequests, addBookToCatalog, formatRelease } from "../../api/apiFunctions.js";
...
const Requests = () => {
    ...
    useEffect(()=> {
        const fetchData = async () => {
            const {bookResult, authorResult} = await getAllRequests();
            console.log(bookResult);
            setBookRequests(bookResult);
            setAuthorRequests(authorResult);
